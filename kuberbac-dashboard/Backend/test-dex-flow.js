...
async function testFlow() {
    try {
        ...
        let res = await client.get("https://192.168.122.23:5556/auth?client_id=kubernetes&response_type=code&redirect_uri=http://localhost:8000&scope=openid+profile+email+groups");
        ...
        console.log("Got Tokens:", Object.keys(res.data));
