...
import LogoSipeka from "../../../../assets/images/logo/custom-logo.svg";
...
const PrintPdfSlipGaji = () => {
    ...
    const handlePrint = useReactToPrint({
        ...
        documentTitle: "Slip_Gaji_Pegawai_Abir",
    });
                        ...
                        <div key={index} className="w-200% h-100% p-10 bg-white dark:bg-meta-4">
                            ...
                            <div className="w-full md:text-lg">
                                <h2 className="font-medium mb-4 block text-black dark:text-white">
                                    <span className="inline-block w-32 md:w-40">User Name</span>
                                    <span className="pl-[-8] md:pl-0"></span>
                                    <span className="inline-block w-7">:</span>
                                    {name}
                                </h2>
                                <h2 className="font-medium mb-4 block text-black dark:text-white">
                                    <span className="inline-block w-32 md:w-40">ID Number</span>
                                    <span className="pl-[-8] md:pl-0"></span>
                                    <span className="inline-block w-7">:</span>
                                    {data.nik}
                                </h2>
                                <h2 className="font-medium mb-4 block text-black dark:text-white">
                                    <span className="inline-block w-32 md:w-40">Namespace</span>
                                    <span className="pl-[-8] md:pl-0"></span>
                                    <span className="inline-block w-7">:</span>
                                    {data.jabatan}
                                </h2>
