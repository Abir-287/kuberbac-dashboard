...
export const getDataJabatan = () => {
    return async (dispatch) => {
        try {
            const response = await axios.get(`${API_URL}/data_jabatan`, { withCredentials: true });
            dispatch({
...
export const updateDataJabatan = (id, data) => {
    return async (dispatch) => {
        try {
            const response = await axios.put(`${API_URL}/data_jabatan/${id}`, data, { withCredentials: true });
            dispatch({
...
export const deleteDataJabatan = (id) => {
    return async (dispatch) => {
        try {
            const response = await axios.delete(`${API_URL}/data_jabatan/${id}`, { withCredentials: true });
            dispatch({
