                    ...
                    {filteredDataGaji
                        .reduce((uniqueEntries, data) => {
                            ...
                            <h2 className="px-4 py-2 text-black dark:text-white" key={`${data.bulan}-${data.tahun}`}>
                                Menampilkan Employee Salary Data Bulan :
                                        ...
                                        <td className='border-b border-[#eee] py-5 px-4 text-center dark:border-strokedark'>
                                            <div className='flex items-center space-x-3.5'>
                                                <Link
                                                    ...
                                                    to={`/salary-data/detail-data-gaji/name/${data.nama_pegawai}`}
                                                >
                ...
                <div className="flex justify-between items-center mt-4 flex-col md:flex-row md:justify-between">
                    <div className="flex items-center space-x-2">
                        <span className="text-gray-5 dark:text-gray-4 text-sm py-4">
                            Showing {startIndex + 1}-{Math.min(endIndex, filteredDataGaji.length)} data {filteredDataGaji.length} Employee Salary Data
                        </span>
                    </div>
